...
const DellLaptops = () => {
  ...
  // 'featured' sorting is the default order from the data
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4">
          <div className="flex items-center mb-8">
            <Button 
              variant="ghost" 
              className="text-gray-300 hover:text-neon-blue mr-4"
              onClick={() => navigate('/')}
            >
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="font-orbitron text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              DELL <span className="text-gradient">ALIENWARE</span> GAMING
            </h1>
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-10">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-6 bg-gaming-darker border border-gaming-accent rounded-lg p-3">
                ...
                <select 
                  className="bg-gaming-accent/50 text-white border border-gaming-accent rounded px-3 py-1 text-sm"
                  value={sortBy}
